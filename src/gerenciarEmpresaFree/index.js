    ...
    <View style={styles.container}>
        ...
        <FlatList
                ...
                <View> 
                  ...
                  title="VIP"
                  price="R$20"
                  info={['Negócios ilimitados', 'Palavras chave ilimitadas', 'Prioridade']}
                  button={{ title: 'SEJA VIP!', icon: 'star' }}
                  onButtonPress={sendWhatsapp}
                />
      ...
      <View style={styles.container}>
        ...
        <FlatList
                ...
                <View style={styles.form}> 
                    ...
                    />
                    <Input
                    placeholder='palavras chaves com virgula, máximo 5'
                    />
